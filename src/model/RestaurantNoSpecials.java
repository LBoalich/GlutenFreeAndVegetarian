...
public class RestaurantNoSpecials extends Restaurant {
    ...
    /* Constructors */
    public RestaurantNoSpecials(){
	    super();
    }

    public RestaurantNoSpecials(String name, String website, String address, String phone, String category, String neighborhood, int lowPrice, int highPrice, boolean hasSpecials, boolean hasMidDayClose, Hours hoursOpened) {
