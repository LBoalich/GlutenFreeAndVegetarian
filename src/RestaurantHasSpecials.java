...
public class RestaurantHasSpecials extends Restaurant{
    ...
    /* Constructors */
    RestaurantHasSpecials(){
	    super();
    }

    RestaurantHasSpecials(String name, String website, String address, String phone, String category, String neighborhood, int lowPrice, int highPrice, boolean hasSpecials, boolean hasMidDayClose, Hours hoursOpened, Hours specials) {
